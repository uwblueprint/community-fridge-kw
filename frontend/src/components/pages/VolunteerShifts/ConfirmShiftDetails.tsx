...
import { DonationFrequency, DonationSizes, SchedulingStepProps } from "../Scheduling/types";
...
isFoodRescue: boolean;}) => {
  ...
  const getShiftData = async () => {
    const shiftResponse = isFoodRescue? await SchedulingAPIClient.getScheduleById(shiftId):
    await CheckInAPIClient.getCheckInsById(shiftId);
    setCurrentShift(shiftResponse);
  };
